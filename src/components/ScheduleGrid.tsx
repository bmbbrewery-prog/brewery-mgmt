        ...
        <div ref={scrollContainerRef} onScroll={handleScroll} className="flex-grow overflow-auto relative scrollbar-hide">
          {!isInitialLoading && (
            <table className="w-full border-collapse table-fixed" style={{ width: `calc(80px + ${sortedTanks.length * columnWidth}px)` }}>
              <thead className="sticky top-0 z-40 bg-white border-b border-slate-300 dark:border-slate-700">
                <tr className="border-b border-slate-300 dark:border-slate-700">
                  <th className="w-20 p-2 border-r border-slate-300 dark:border-slate-700 sticky left-0 z-50 bg-slate-50 dark:bg-slate-900">
